...
@cloud_market_bp.route("/listings", methods=["GET"])
def get_listings():
    """
...
@cloud_market_bp.route("/listings/<int:listing_id>", methods=["GET"])
...
@cloud_market_bp.route("/listings", methods=["POST"])
@jwt_required()
def create_listing():
    """
...
@cloud_market_bp.route("/listings/<int:listing_id>", methods=["PUT"])
@jwt_required()
...
@cloud_market_bp.route("/listings/<int:listing_id>", methods=["DELETE"])
@jwt_required()
...
# --- BARGAINING / OFFERS SYSTEM ---

@cloud_market_bp.route("/listings/<int:listing_id>/offers", methods=["POST"])
@jwt_required()
...
@cloud_market_bp.route("/offers/my-offers", methods=["GET"])
@jwt_required()
def get_my_offers():
...
@cloud_market_bp.route("/offers/incoming", methods=["GET"])
@jwt_required()
...
@cloud_market_bp.route("/offers/<int:offer_id>/respond", methods=["PUT"])
@jwt_required()
...
@cloud_market_bp.route("/offers/<int:offer_id>/accept-counter", methods=["PUT"])
@jwt_required()
